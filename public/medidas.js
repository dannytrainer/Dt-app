      ...
      <div id="${idDetalle}" style="display:none;padding:10px 12px;border-top:1px solid #1a1a1a">
        ...
        ${(fFrontal || fLateral) ? `
          <div style="display:flex;gap:8px;margin-top:8px">
            ${fFrontal ? `<img src="${fFrontal}" onclick="verFotoGrande(this.src)" style="flex:1;min-width:0;border-radius:8px;cursor:pointer;max-height:160px;object-fit:cover">` : ''}
            ${fLateral ? `<img src="${fLateral}" onclick="verFotoGrande(this.src)" style="flex:1;min-width:0;border-radius:8px;cursor:pointer;max-height:160px;object-fit:cover">` : ''}
          </div>` : ''}
