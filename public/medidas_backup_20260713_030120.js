...
function configurarZoomCamara() {
  ...
  // Intento adicional: algunos navegadores no reportan getCapabilities().zoom
  // pero sí aceptan el constraint si se lo pedimos directamente (bug de timing/soporte parcial)
  slider.min = 0.5;
  slider.max = 2;
  slider.step = 0.1;
  slider.value = 1;
  slider.style.display = 'block';
  document.getElementById('camara-zoom-valor').textContent = '1x (no confirmado)';
}
