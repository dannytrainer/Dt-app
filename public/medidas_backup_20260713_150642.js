...
async function capturarFotoCamara() {
  ...
  const orientacionPantalla = (screen.orientation && screen.orientation.angle) || 0;
  console.log('DEBUG cámara: videoWidth=' + vw + ' videoHeight=' + vh + ' orientationAngle=' + orientacionPantalla);
  toast('📐 ' + vw + 'x' + vh + ' ángulo:' + orientacionPantalla, true);
